...
- [ ] Explain the difference between `Relational Databases` and `SQL`.
    ...
    --Relational Databases are sets of tables used to store data, while SQL can help search for that information.

- [ ] Why do tables need a `primary key`?

    --It helps prevent duplicate entries and errors.  A unique primary key helps searching for items much easier.
...
- [ ] What do we need in order to have a _many to many_ relationship between two tables.
    ...
    --A new table that has its own primary key and foreign keys linking to the other tables.
